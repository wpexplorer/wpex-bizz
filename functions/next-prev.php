...
if ( ! function_exists( 'wpex_next_prev' ) ) {
	function wpex_next_prev() {
		...
		<ul class="single-post-pagination clr">
			<?php next_post_link( '<li class="post-prev">%link</li>', '<i class="fa fa-arrow-circle-o-left"></i>' ); ?><?php previous_post_link( '<li class="post-next">%link</li>', '<i class="fa fa-arrow-circle-o-right"></i>' ); ?>
